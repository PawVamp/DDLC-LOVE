...
function updateGame()	
	...
	if poem_enabled and poem_scroll and not menu_enabled then
		if joystick:isGamepadDown('up') and poem_scroll.y < 1 then
			poem_scroll.y = poem_scroll.y + dt*10
		elseif joystick:isGamepadDown('down') then
			poem_scroll.y = poem_scroll.y - dt*10
		elseif joystick:isGamepadDown('left') and poem_scroll.x < 1 then
			poem_scroll.x = poem_scroll.x + dt*10
		elseif joystick:isGamepadDown('right') then
			poem_scroll.x = poem_scroll.x - dt*10
		end
	end
